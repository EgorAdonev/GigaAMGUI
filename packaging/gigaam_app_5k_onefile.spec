...
"""
PyInstaller spec Ð´Ð»Ñ GigaAM v3 Transcriber â€” RTX 5000 Series (CUDA 12.8, Blackwell)
"""
...
for _dll in ['_lzma.pyd', '_bz2.pyd', '_sqlite3.pyd']:
    _p = os.path.join(r'C:\Users\baggr\miniconda3\envs\gigaam_5k\DLLs', _dll)
...
exe = EXE(
    ...
    name='GigaAMTranscriber_5000_onefile',
    debug=False,
