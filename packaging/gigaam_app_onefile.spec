...
"""
PyInstaller spec Ð´Ð»Ñ GigaAM v3 Transcriber (torch 2.6 CPU)
"""
...
# liblzma.dll Ð¾Ñ‚ÑÑƒÑ‚ÑÑ‚Ð²ÑƒÐµÑ‚ Ð² gigaam env Ð½Ð¾ Ð½ÑƒÐ¶Ð½Ð° Ð´Ð»Ñ _lzma.pyd
...
exe = EXE(
    ...
    name='GigaAMTranscriber_onefile',
    debug=False,
