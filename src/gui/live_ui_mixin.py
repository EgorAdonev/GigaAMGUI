...
class LiveUiMixin:
    def _create_live_tab(self) -> QWidget:
        ...
        self.btn_live_overlay.setToolTip(
            self._t("Показать или скрыть оверлей поверх окон", "Show or hide the always-on-top overlay")
        )
        ...
        layout.addWidget(self.lbl_live_problem)
